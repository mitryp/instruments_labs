import {compileFiltersToPredicate, Filter, Filters} from "./filter/filtering.js";
import {Sort, SortOrder, SortOrderType} from "./sort/sorting.js";
...
export class QueryBuilder {
    ...
    public removeFilterType(filter: Filter): QueryBuilder {
        _.remove(this.filters, f => f.name === filter.name);
