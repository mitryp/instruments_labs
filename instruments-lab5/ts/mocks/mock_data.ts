...
export function mockUserData(data?: User[]): User[] {
    data ??= mergeUserArrays(normalizeUserData(randomUserMock), additionalUsers as UserInterface[]);
